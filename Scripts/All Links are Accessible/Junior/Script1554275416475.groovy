...
WebUI.comment('Verifying Whether Links are Working or not when we click on Junior buynow page')

'Opening browser'
WebUI.openBrowser('')

'Junior URL'
WebUI.navigateToUrl('http://192.168.0.28:90/detail/13/JUNIOR/12')

WebUI.delay(5)

'Verifying whether it is actual page or not '
WebUI.verifyTextPresent('JUNIOR MEMBERSHIP', false)
