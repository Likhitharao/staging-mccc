...
WebUI.comment('Verifying Whether Links are Working or not when we click on Country Buynow')

'Opening the browser'
WebUI.openBrowser('')

'MCCC Country page URL'
WebUI.navigateToUrl('http://192.168.0.28:90/detail/7/COUNTRY/2')

WebUI.delay(5)

'Verifying whether it is actual page or not '
WebUI.verifyTextPresent('COUNTRY MEMBERSHIP', false)
