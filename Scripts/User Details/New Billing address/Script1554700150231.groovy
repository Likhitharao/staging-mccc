...
WebUI.click(findTestObject('User Details/New Billing address/Page_/input_Same as billing address_ca_deliveryoption'))
...
'Enter street'
WebUI.setText(findTestObject('User Details/New Billing address/Page_/input_Street_ca_deliveryorderbaseaddressaddress1'), 
    'Link street')

'Enter Address'
WebUI.setText(findTestObject('User Details/New Billing address/Page_/input_Address_ca_deliveryorderbaseaddressaddress2'), 
    '56/7')

'Enter city'
WebUI.setText(findTestObject('User Details/New Billing address/Page_/input_City_ca_deliveryorderbaseaddresscity'), 'chennai')
...
WebUI.setText(findTestObject('User Details/New Billing address/Page_/input_Postal code_ca_deliveryorderbaseaddresspostal'), 
    '562396')
